...
--hex --eta --flush-session --fresh-queries --drop-set-cookie \
...
--keep-alive --answers="quit=N" --timeout=90 --retries=15 --threads=10 \
--technique=BEUSTQ --risk=3 --level=5 --batch --drop-set-cookie
