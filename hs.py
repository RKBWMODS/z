...
def register_user():
    ...
    # Menentukan path untuk menyimpan file verifikasi
    verification_file_path = "/sdcard/Download/verification_code.txt"
    
    # Simpan kode verifikasi ke file di /sdcard/Download
    try:
        with open(verification_file_path, "w") as f:
            f.write(verification_code)
        print(f"Kode verifikasi telah disimpan. Silakan buka file '{verification_file_path}' untuk melihat kode verifikasi.")
